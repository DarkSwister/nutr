...
use App\Domains\Auth\Models\AccountPaymentGateway;
...
class UserService extends BaseService
{
    ...
    public function registerUser(array $data = []): User
    {
        ...
        try {
            ...
            if (isset($data['group_id'])) {
                ...
                Invitation::where('group_id', $data['group_id'])->where('email', $data['email'])->update(['registered_at' => Carbon::now()]);
            }
        } catch (Exception $e) {
            DB::rollBack();
    ...
    protected function createPaymentGateway(Account $account): AccountPaymentGateway
    {
        return AccountPaymentGateway::create([

...
class Account extends MyBaseModel
{
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function account_payment_gateways(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(AccountPaymentGateway::class);
    }
     ...
     */
    public function active_payment_gateway(): \Illuminate\Database\Eloquent\Relations\HasOne
    {
        return $this->hasOne(AccountPaymentGateway::class, 'payment_gateway_id', 'payment_gateway_id')->where('account_id', $this->id);
    }

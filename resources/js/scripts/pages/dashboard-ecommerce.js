...
$(window).on('load', function () {
  ...
  //----------------------------------------------
    let $pieChartSmall = document.querySelectorAll('.pie-chart-small');
    console.log($pieChartSmall);
    [].forEach.call($pieChartSmall, function(current) {
        let pieChartOptions = {
            chart: {
                height: 30,
                width: 30,
            ...
            colors: [(current.getAttribute('data-chart-color') || window.colors.solid.primary)],
            series: [(current.getAttribute('data-chart-value') || 0)],
            plotOptions: {
                radialBar: {
                    hollow: {
                        size: '22%'
        ...
        let pie_chart_apex = new ApexCharts(current, pieChartOptions);
        pie_chart_apex.render();
    });
  ...
  goalOverviewChartOptions = {
    ...
    series: [($goalOverviewChart.getAttribute('data-apex-value') || 0)],
    stroke: {
      lineCap: 'round'
    },
    grid: {

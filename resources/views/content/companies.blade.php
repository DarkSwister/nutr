        ...
        <div class="card-body">
            <div class="card-text">
                <div class="position-relative table-responsive">
                    <table role="table" aria-busy="false" aria-colcount="6" class="table b-table" id="__BVID__1108">
                        <!----><!---->
                        ...
                        <tr role="row" id="__BVID__1108__row_50" data-pk="50" class="">
                            ...
                            <td aria-colindex="1" role="cell" class="">
                                <div class="media d-flex align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <small class="text-muted">mikrotīkls</small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td aria-colindex="6" role="cell" class="">
                                <a href="{{route('company-details', ['company' => 1])}}">skatīt vairāk</a>
                            </td>
                        </tr>
                        <!----><!---->
                        </tbody>

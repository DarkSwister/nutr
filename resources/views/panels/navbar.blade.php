                    ...
                    <ul class="nav navbar-nav align-items-center ms-auto">
                        <li class="nav-item dropdown dropdown-language">
                            <a class="nav-link dropdown-toggle" id="dropdown-flag" href="#" data-bs-toggle="dropdown"
                               aria-haspopup="true">
                                @if(app()->getLocale() == 'lv')
                                    ...
                                    <span class="selected-language">Latvian</span>
                                @else
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
                                <a class="dropdown-item" href="{{ url('lang/lv') }}" data-language="lv">
                                    <i class="flag-icon flag-icon-lv"></i> Latvian
                                </a>
                        ...
                        <li class="nav-item dropdown dropdown-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                                ...
                                @if(auth()->user()->isSetup())
                                    ...
                                    <h6 class="dropdown-header">@lang('Selected Group')</h6>
                                    <div class="px-1">
                                        <select onchange="window.location.href=this.value;" class="form-select"
                                            ...
                                            @foreach(auth()->user()->groups as $group)
                                                ...
                                                <option
                                                    value="{{ route('group.switch',$group->id) }}"
                                                    @if(session('group_id') == $group->id) selected @endif
                                                ">{{$group->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <a class="dropdown-item"
                                   href="{{ Route::has('frontend.user.profile') ? route('frontend.user.profile') : 'javascript:void(0)' }}">
                                    <i class="me-50" data-feather="user"></i> Profile
                                </a>
                                <a class="dropdown-item"
                                   href="{{ Route::has('frontend.user.profile-settings') ? route('frontend.user.profile-settings') : 'javascript:void(0)' }}">
                                ...
                                @if (Auth::check())
                                    ...
                                    <form method="POST" id="logout-form" action="{{ route('frontend.auth.logout') }}">
                                        @csrf
                                    </form>
                                @else
                                    <a class="dropdown-item"

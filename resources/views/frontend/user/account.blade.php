                ...
                <x-frontend.card>
                    ...
                    <x-slot name="body">
                        ...
                        <div class="tab-content" id="my-profile-tabsContent">
                            <div class="tab-pane fade pt-3 " id="my-profile" role="tabpanel" aria-labelledby="my-profile-tab">
                            ...
                            <div class="tab-pane fade pt-3 show active" id="two-factor-authentication" role="tabpanel" aria-labelledby="two-factor-authentication-tab">

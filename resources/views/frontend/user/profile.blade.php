                    ...
                    <div class="position-relative">
                        ...
                        <div class="profile-img-container d-flex align-items-center">
                            <div class="profile-img">
                                <img
                                    src="https://avatars.dicebear.com/api/big-ears-neutral/your-custom-seed.svg"
                            ...
                            <div class="profile-title ms-3">
                                <h2 class="text-white">Timurka Beats</h2>
                                <p class="text-white">Pupper</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                ...
                                <p class="card-text">September 15, 2022</p>
                            </div>
                            <div class="mt-2">
                            ...
                            <div class="mt-2">
                                ...
                                <p class="card-text">tim@test.com</p>
                            </div>
                            <div class="mt-2">
                                <h5 class="mb-50">Website:</h5>
                                <p class="card-text mb-0">www.freedomvision.com</p>
                            </div>
                        </div>
                    </div>
                    <!--/ about -->
...
{{--                                        <h6 class="mb-0">Timurka Beats</h6>--}}
{{--                                        <a href="#">--}}
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                ...
                                <div class="profile-user-info">
                                    <h6 class="mb-0">Kevin Paradox</h6>
                                    <small class="text-muted">12 Aug 2022 at 1:16 AM</small>
                                </div>
                            </div>
                            <!--/ avatar image title -->
...
{{--                                src="https://www.youtube.com/embed/kr5Nvf-pjyY?start=62"--}}

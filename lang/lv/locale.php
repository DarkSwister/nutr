...
return [
    ...
    "Users" => "Lietotāji",
    "Projects" => "Projekti",
    "Solar parks" => "Saules parks",
    "Companies" => "Uzņēmumi",
    "Events" => "Eventi",
    "Power Overview" => "Ražošanas pārskats",
    "Inverter Overview" => "Invertoru pārskats",
    "Clients" => "Klienti",
    "Platform users" => "Platformas Lietotāji",
    "Dashboard" => "Panelis",
    'inverters' => "Invertori",
    'inverter_details' => "Ražošanas Pārskats",
    'inverter_overview' => "Invertoru Pārskats",
    'create_inverter' => "Izveidot invertoru",
    'add_inverter' => "Pievienot invertoru",
    ...
    'form' => [
        ...
        'location_lat_long' => "Atrašanās vieta (lat,long)",
        'api_url' => 'API Url',
        'api_username' => "API Lietotāja vārds",
        'api_password' => "API Parole",
        'api_token' => "API Tokens",
        'max_capacity' => "Maksimālā kapacitāte",
        'max_battery_capacity' => "Maksimālā baterijas kapacitāte",
        'has_battery' => "Ir akumulators",
        'select' => "Izvēlieties",
        'yes' => 'Jā',
        'no' => 'Nē',
        'has_limits' => 'Ir limiti',
        'submit' => "Iesniegt",
        'reset' => "Atiestatīt"
    ],
